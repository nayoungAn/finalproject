    ...
    <>
      <form className={TeacherClassDetailCSS.background}>
        <div className={TeacherClassDetailCSS.balance}>
          <tr>
            ...
            {classesDetail.member && (
              <td className={TeacherClassDetailCSS.classteacher}>
                {classesDetail.member.memberName}
              </td>
            )}
          </tr>
          ...
          <tr>
            <th>수강 모집인원</th>
            <td className={TeacherClassDetailCSS.quota}>
              {classesDetail.classQuota}
            </td>

            <th>강의실</th>
            <td className={TeacherClassDetailCSS.classRoom}>
              {classesDetail.classRoom}
            </td>
          </tr>
          ...
          <div className={TeacherClassDetailCSS.classnote}>
            ...
            {classesDetail.subject && (
              <td className={TeacherClassDetailCSS.note}>
                {classesDetail.subject.subjectDescription}
              </td>
            )}
          </div>
